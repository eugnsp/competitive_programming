...
| 003 48 | Optimal array mult. sequence		| Matrix-chain multiplication (dynamic programming)				|
...
| 007 01 | Archeologists dilemma 			|
| 007 14 | Copying books 					| Linear partitioning (binary search)							|
| 007 29 | Hamming distance problem 		|
...
| 009 91 | Safe salutations 				| Combinatorics	(Catalan numbers)								|
...
| 100 04 | Bicoloring 						|
| 100 61 | How many zeros digits 			|
| 101 07 | What is the median 				| `std::priority_queue`											|
| 101 71 | Meeting prof. Miguel 			|
| 102 23 | How many nodes 					| Combinatorics	(Catalan numbers)								|
...
| 103 82 | Watering grass 					| Interval covering (greedy)									|
...
| 121 92 | Grapevine 						|
| 122 38 | Ants colony 						|
| 123 47 | Binary search tree 				| Binary search trees, pre/post-order traversals				|
| 124 55 | Bars 							|
| 124 58 | Oh,my trees! 					|
