...
Goal:	find the total area of all attacked kingdoms.
...
private:
	...
	{
		// <number of sites in the first kingdom = k>
		// <x_1> <y_1>
		// ...
		// <x_k> <y_k>
		// <number of sites in the second kingdom>
		// ...
		// <-1>
		// <number of missile attacks = m>
		// <x_1> <y_1>
		// ...
		// <x_m> <y_m>
	...
	virtual void solve(std::ostream& out, std::size_t) override
	{
		...
		out << std::setprecision(2) << std::fixed << total_area << '\n';
	}
