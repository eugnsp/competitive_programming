...
Goal:	the number of days of the shortest conclusive
		non-adaptive test scheme.
...
private:
	...
	virtual void solve(std::ostream& out, std::size_t) override
	{
		...
		**********************************************************************/
		...
		out << min_length(no_allergens_mask, 0) << '\n';
	}
