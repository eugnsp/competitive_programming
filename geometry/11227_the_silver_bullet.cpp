...
Goal:	find the maximum number of aligned gnus.
...
class The_silver_bullet : public CP1
{
private:
	using T = int;
...
private:
	...
	virtual void solve(std::ostream& out, std::size_t i_case) override
	{
		...
		**********************************************************************/
		...
		if (n_gnus_max == 1)
			out << "Data set #" << i_case + 1 << " contains a single gnu.\n";
		else
			out << "Data set #" << i_case + 1 << " contains " << gnus_.size()
